...
const LoginPage = () => {
  ...
  return (
    <div className="login-page"><div className="login-card">
      <h1>🚐 SchoolTransport</h1><p>Sign in to manage your school's transport fleet</p>
      ...
      <div style={{marginTop:'1.5rem',padding:'1rem',background:'#f0f9ff',borderRadius:'8px',fontSize:'.8rem',color:'#1e40af'}}>
        <strong>Demo:</strong><br/>Admin: admin@nairobiacademy.co.ke / admin123<br/>Driver: driver1@nairobiacademy.co.ke / driver123<br/>Parent: parent1@gmail.com / parent123
      </div>
    </div></div>);
};
