...
export const tripAPI = { getAll: p => api.get('/trips',{params:p}), getDetails: id => api.get(`/trips/${id}/details`), create: d => api.post('/trips',d), start: id => api.put(`/trips/${id}/start`), end: id => api.put(`/trips/${id}/end`), logAction: (id,d) => api.post(`/trips/${id}/log`,d), getLogs: id => api.get(`/trips/${id}/logs`) };
